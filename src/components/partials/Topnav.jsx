    ...
    return (
        <div className="w-full h-[10vh] relative flex justify-center items-center ">
            ...
            <input onChange={(e) => setquery(e.target.value)}
             value={query}
             className="text-zinc-200 w-[50%] mx-10 p-5 rounded-full text-xl outline outline-[#6556CD] border-none bg-transparent " type="text" placeholder="search anything" />
             {query.length >0 && (
               <i onClick={() => setquery("")} className="text-zinc-400 text-3xl ri-close-circle-line"></i>
             )}
            
            
            <div className="z-[100] absolute w-[50%] max-h-[50vh] bg-zinc-200 top-[100%] left-[25%] overflow-auto rounded-md ">
            {searches.map((s,i) => (
